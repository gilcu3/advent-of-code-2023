...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `59.6µs` | `482.1µs` |
| [Day 2](./src/bin/02.rs) | `217.9µs` | `270.8µs` |
| [Day 3](./src/bin/03.rs) | `103.6µs` | `827.3µs` |
| [Day 4](./src/bin/04.rs) | `337.0µs` | `341.9µs` |
| [Day 5](./src/bin/05.rs) | `57.8µs` | `99.9µs` |
| [Day 6](./src/bin/06.rs) | `304.0ns` | `439.0ns` |
| [Day 7](./src/bin/07.rs) | `3.2ms` | `3.0ms` |
| [Day 8](./src/bin/08.rs) | `574.4µs` | `5.1ms` |
| [Day 9](./src/bin/09.rs) | `407.3µs` | `388.3µs` |
| [Day 10](./src/bin/10.rs) | `2.5ms` | `3.2ms` |
| [Day 11](./src/bin/11.rs) | `1.6ms` | `2.3ms` |
| [Day 12](./src/bin/12.rs) | `2.7ms` | `68.2ms` |
| [Day 13](./src/bin/13.rs) | `236.9µs` | `14.7ms` |
| [Day 14](./src/bin/14.rs) | `80.9µs` | `56.6ms` |
| [Day 15](./src/bin/15.rs) | `121.4µs` | `392.5µs` |
| [Day 16](./src/bin/16.rs) | `796.2µs` | `53.7ms` |
| [Day 17](./src/bin/17.rs) | `8.0ms` | `13.0ms` |
| [Day 18](./src/bin/18.rs) | `835.8µs` | `53.8µs` |
| [Day 19](./src/bin/19.rs) | `288.3µs` | `310.2µs` |
| [Day 20](./src/bin/20.rs) | `5.2ms` | `49.1ms` |
| [Day 21](./src/bin/21.rs) | `210.0µs` | `84.6ms` |
| [Day 22](./src/bin/22.rs) | `848.6µs` | `1.8ms` |
| [Day 23](./src/bin/23.rs) | `4.3ms` | `24.9ms` |
| [Day 24](./src/bin/24.rs) | `4.0ms` | `3.5ms` |
| [Day 25](./src/bin/25.rs) | `222.1ms` | `-` |
